...
public class SimpleHuffProcessor implements IHuffProcessor {
	...
	public int preprocessCompress(InputStream in, int headerFormat) throws IOException {
		...
		// returning the pre-compressedBits by taking the originalBits minus the TOTAL bits of
		// the compressed file (magic number bits (32), format number bits (32), header bits, and
	...
	public int compress(InputStream in, OutputStream out, boolean force) throws IOException {
		...
		if ((force == true && preprocessedBits < 0) || preprocessedBits >= 0) {
			...
			// printing out the actual data as encoded binary numbers instead of regular 8 bits
			// binary numbers, the encoded binary numbers is from the map that were created during
	...
	// actual method to print out the encoded data using information from the map that we created
