...
public class TreeNode implements Comparable<TreeNode> {
	...
	/*
	 * The value stored in this node. A number read from a file. No matter the file
	 * type we read in bits and treat the data as an int.
	 */	
	private int value;

	/*
	 * The frequency of the value for leaf nodes or the sum of the frequency of the
	 ...
	 * The new node's frequency will be the sum of the frequencies of leftSubtree
	 * and rightSubtree.
	 * 
	 ...
	 * 
	 * @return A String version of this node including the frequency (weight) and
	 *         value.
	 */
	 ...
	 * 
	 * @return the frequency of this node. For internal nods the value should be the
	 *         sum of the child nodes
	 */
